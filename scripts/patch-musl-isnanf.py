...
X64_ROBUST_LINUX_INSERT = (
    ...
    '                // 二级伪造：满足 [*head & ~1 - 8] == head 链表回指校验\n'
    '                static struct { uintptr_t back; } rh_back = {0};\n'
    '                static struct {\n'
    '                    uintptr_t next;\n'
    '                    long futex_offset;\n'
    '                    long list_op_pending;\n'
    '                } rh = {0};\n'
    '                rh_back.back = (uintptr_t)&rh;\n'
    '                rh.next = (uintptr_t)&rh_back + 8;\n'
    ...
    '                printf_log(LOG_NONE, "[ROBUST] lin274 rh=%p sz=%zu off=0x%lx\\n", (void*)&rh, sizeof(rh), (unsigned long)rh.futex_offset);\n'
    '                S_RAX = 0;\n'
    '            }\n'
    '            break;\n'
)
...
X64_ROBUST_MYSC_INSERT = (
    ...
    '            {\n'
    '                // 无条件伪造：native head 的 futex_offset 不是 x64 期望的 -0x20\n'
    '                // 二级伪造：steamclient 0x1e5802e 校验 [*head & ~1 - 8] == head（链表回指）\n'
    '                //   rax=&rh, rdx=[&rh]&~1=&rh_back+8, [rdx-8]=[&rh_back]=&rh=rx 成立\n'
    '                static struct { uintptr_t back; } rh_back = {0};\n'
    '                static struct {\n'
    '                    uintptr_t next;\n'
    '                    long futex_offset;\n'
