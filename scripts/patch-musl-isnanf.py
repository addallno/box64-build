...
X64_ROBUST_MYSC_INSERT = (
    ...
    '                rh.futex_offset = -0x20;\n'
    '                rh.list_op_pending = 0;\n'
    '                printf_log(LOG_NONE, "[ROBUST] my274 enter head_p=%p len_p=%p RSI=%p RIP=%p\\n", (void*)R_RDX, (void*)R_RCX, (void*)R_RSI, (void*)R_RIP);\n'
    ...
    '                if(R_RDX && *(uintptr_t*)R_RDX)\n'
    '                    printf_log(LOG_NONE, "[ROBUST] my274 verify *head=%p *len=%zu [head+8]=0x%lx\\n",\n'
    '                        (void*)*(uintptr_t*)R_RDX,\n'
    '                        R_RCX ? *(size_t*)R_RCX : (size_t)0,\n'
    '                        (unsigned long)((uintptr_t)*(uintptr_t*)R_RDX) ? (unsigned long)(((uintptr_t*)*(uintptr_t*)R_RDX)[1]) : 0UL);\n'
    '                return 0;\n'
    '            }\n'
)
