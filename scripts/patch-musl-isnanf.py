...
X64_ROBUST_LINUX_INSERT = (
    ...
    '            printf_log(LOG_NONE, "[ROBUST] lin273 enter RDI=%p RSI=%p RDX=%p R10=%p\\n", (void*)R_RDI, (void*)R_RSI, (void*)R_RDX, (void*)R_R10);\n'
    '            S_RAX = 0;\n'
    '            break;\n'
    '        case 274: // sys_get_robust_list\n'
    '            {\n'
    '                // 自包含二级伪造：[*head & ~1 - 8] == head（同 my274）\n'
    '                static struct {\n'
    '                    uintptr_t next;\n'
    '                    long futex_offset;\n'
    ...
    '                    uintptr_t tail;\n'
    '                } rh = {0};\n'
    '                rh.next = (uintptr_t)&rh + 0x20;\n'
    '                rh.futex_offset = -0x20;\n'
    '                rh.list_op_pending = 0;\n'
    '                rh.head_ref = (uintptr_t)&rh;\n'
    '                printf_log(LOG_NONE, "[ROBUST] lin274 enter head_p=%p len_p=%p RDI=%p R10=%p\\n", (void*)R_RSI, (void*)R_RDX, (void*)R_RDI, (void*)R_R10);\n'
    '                if(R_RSI) *(uintptr_t*)R_RSI = (uintptr_t)&rh;\n'
    '                else printf_log(LOG_NONE, "[ROBUST] lin274 R_RSI NULL, head NOT written\\n");\n'
    '                if(R_RDX) *(size_t*)R_RDX = 0x18;\n'
    '                else printf_log(LOG_NONE, "[ROBUST] lin274 R_RDX NULL, len NOT written\\n");\n'
    '                printf_log(LOG_NONE, "[ROBUST] lin274 rh=%p next=%p href=%p off=0x%lx chk_ok=%d\\n", (void*)&rh, (void*)rh.next, (void*)rh.head_ref, (unsigned long)rh.futex_offset, (int)((*(uintptr_t*)((rh.next & ~(uintptr_t)1) - 8)) == (uintptr_t)&rh));\n'
    '                S_RAX = 0;\n'
    '            }\n'
    '            break;\n'
)
...
X64_ROBUST_MYSC_INSERT = (
    ...
    '            printf_log(LOG_NONE, "[ROBUST] my273 enter RSI=%p RDX=%p RCX=%p\\n", (void*)R_RSI, (void*)R_RDX, (void*)R_RCX);\n'
    '            return 0;\n'
    '        case 274: // sys_get_robust_list（libc syscall 路径）\n'
    '            {\n'
    '                // 自包含二级伪造：steamclient 0x1e5802e 校验 [*head & ~1 - 8] == head\n'
    '                //   head=&rh; rdx=rh.next=&rh+0x20; [rdx-8]=[rh+0x18]=head_ref=&rh=head ✓\n'
    '                //   len 必须为 0x18（断言 cmp [rsp+0x18],0x18），与 sizeof 无关\n'
    '                static struct {\n'
    '                    uintptr_t next;\n'
    '                    long futex_offset;\n'
    '                    long list_op_pending;\n'
    ...
    '                rh.list_op_pending = 0;\n'
    '                rh.head_ref = (uintptr_t)&rh;\n'
    '                printf_log(LOG_NONE, "[ROBUST] my274 enter tid=%d rsp=%p head_p=%p len_p=%p RSI=%p RIP=%p dRDX=%ld\\n", GetTID(), (void*)R_RSP, (void*)R_RDX, (void*)R_RCX, (void*)R_RSI, (void*)R_RIP, (long)((intptr_t)R_RDX - (intptr_t)(R_RSP + 0x10)));\n'
    '                // 诊断：写前原值（栈上返回地址、guest canary、+0x170..+0x1a0 槽位）\n'
    '                printf_log(LOG_NONE, "[ROBUST] my274 diag retp=%p canary=%016llx p170=%016llx p178=%016llx p180=%016llx p188=%016llx p190h=%016llx p198=%016llx p1a0=%016llx\\n",\n'
    '                    (void*)(R_RSP ? *(uintptr_t*)R_RSP : 0),\n'
    '                    (unsigned long long)*(uintptr_t*)emu->context->canary,\n'
    '                    (unsigned long long)(R_RDX ? *(uintptr_t*)((char*)R_RDX + 0x170) : 0),\n'
    '                    (unsigned long long)(R_RDX ? *(uintptr_t*)((char*)R_RDX + 0x178) : 0),\n'
    '                    (unsigned long long)(R_RDX ? *(uintptr_t*)((char*)R_RDX + 0x180) : 0),\n'
    '                    (unsigned long long)(R_RDX ? *(uintptr_t*)((char*)R_RDX + 0x188) : 0),\n'
    '                    (unsigned long long)(R_RDX ? *(uintptr_t*)((char*)R_RDX + 0x190) : 0),\n'
    '                    (unsigned long long)(R_RDX ? *(uintptr_t*)((char*)R_RDX + 0x198) : 0),\n'
    '                    (unsigned long long)(R_RDX ? *(uintptr_t*)((char*)R_RDX + 0x1a0) : 0));\n'
    '                if(R_RDX) *(uintptr_t*)R_RDX = (uintptr_t)&rh;\n'
    '                else printf_log(LOG_NONE, "[ROBUST] my274 R_RDX NULL, head NOT written\\n");\n'
    '                if(R_RCX) *(size_t*)R_RCX = 0x18;\n'
    ...
    '                if(R_RCX) *(size_t*)((char*)R_RCX + 0x190) = 0x18;\n'
    ...
    '                printf_log(LOG_NONE, "[ROBUST] my274 rh=%p next=%p href=%p off=0x%lx chk_ok=%d\\n", (void*)&rh, (void*)rh.next, (void*)rh.head_ref, (unsigned long)rh.futex_offset, (int)((*(uintptr_t*)((rh.next & ~(uintptr_t)1) - 8)) == (uintptr_t)&rh));\n'
    '                printf_log(LOG_NONE, "[ROBUST] my274 rspslot *hs=%p *ls=%p hs=0x%lx ls=%zu +190hs=%p +190ls=%p\\n",\n'
    '                    (void*)(R_RSP ? *(uintptr_t*)(R_RSP + 0x10) : 0),\n'
    '                    (void*)(R_RSP ? *(uintptr_t*)(R_RSP + 0x18) : 0),\n'
    '                    (unsigned long)(R_RDX ? *(uintptr_t*)R_RDX : 0),\n'
    '                    (size_t)(R_RCX ? *(size_t*)R_RCX : 0),\n'
    '                    (void*)(R_RDX ? *(uintptr_t*)((char*)R_RDX + 0x190) : 0),\n'
    '                    (void*)(R_RCX ? *(size_t*)((char*)R_RCX + 0x190) : 0));\n'
    '                return 0;\n'
    '            }\n'
)
