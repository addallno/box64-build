...
def generate_header(func_refs, data_refs, sigs, smart, out_path,
    ...
    _KNOWN_MUSL_DECLS = {
        ...
        "sem_unlink", "sem_wait",
        # musl <resolv.h> 声明（wrappedlibresolv.c 已自行 #include <resolv.h>）
        "__dn_comp", "__dn_expand", "__dn_skipname", "dn_expand", "dn_skipname",
        "__ns_get16", "__ns_get32", "ns_get16", "ns_get32",
        "ns_datetosecs", "ns_format_ttl", "ns_initparse", "ns_makecanon",
        "ns_name_compress", "ns_name_ntol", "ns_name_ntop", "ns_name_pack",
        "ns_name_pton", "ns_name_rollback", "ns_name_skip",
        "ns_name_uncompress", "ns_name_unpack",
        "ns_parserr", "ns_parse_ttl", "ns_put16", "ns_put32",
        "ns_samedomain", "ns_samename", "ns_skiprr",
        "ns_sprintrr", "ns_sprintrrf", "ns_subdomain",
        "__ns_name_ntop", "__ns_name_unpack",
        "__p_cdname", "__p_cdnname", "__p_class", "__p_fqname",
        "__p_fqnname", "__p_option", "__p_query", "__p_rcode", "__p_type",
        "__putlong", "__putshort",
        "__res_close", "__res_dnok", "__res_hnok", "__res_hostalias",
        "__res_isourserver", "__res_mailok", "__res_mkquery",
        "__res_nameinquery", "__res_ownok", "__res_queriesmatch",
        "__res_query", "__res_querydomain", "__res_search", "__res_send",
        "__res_state", "__sym_ntop", "__sym_ntos", "__sym_ston",
        "__b64_ntop", "__b64_pton",
        "__fp_nquery", "__fp_query", "__fp_resstat",
        "__hostalias", "inet_neta", "inet_net_ntop", "inet_net_pton",
        "__loc_aton", "__loc_ntoa",
        "res_mkquery", "res_nmkquery", "res_nquery", "res_nquerydomain",
        "res_nsearch", "res_nsend", "res_query", "res_querydomain",
        "res_search",
    }
